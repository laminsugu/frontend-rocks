...
const[title,settitle]=useState("Green ninja ash");
  return (
    <div className="h-dvh flex flex-col items-center justify-center">
      <div className="bg-white p-8 rounded-md shadow-lg">
        ...
        <div className="flex flex-col items-center space-y-4">
          <button
            className="bg-green-500 text-white px-4 py-2 rounded-md shadow-md cursor-pointer hover:bg-blue-600 transition-colors"
        ...
        <p className="text-center text-sm text-green-400">Clicca sui loghi per saperne di più</p>
      </div>
    </div>
  );
}
